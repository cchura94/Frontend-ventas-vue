      ...
      <v-app id="inspire">
        ...
        >
          ...
          <v-toolbar-title style="width: 300px" class="ml-0 pl-4">
            <span class="hidden-sm-and-down">Sis Ventas</span>
          </v-toolbar-title>
          <v-text-field
            flat
            solo-inverted
  ...
  data: () => ({
    ...
    items: [
      { icon: "mdi-contacts", text: "Usuarios", url:"/admin/usuario" },
      {
        ...
        text: "GESTION CATEGORIAS",
        model: true,
        children: [
          { icon: "mdi-home", text: "Lista Categoria", url:"/admin/categoria" }
        ],
      },
      {
        icon: "mdi-chevron-up",
        ...
        model: false,
        children: [
          { icon: "mdi-plus", text: "Nuevo Producto", url:"/admin/producto/nuevo" },
      ...
      },
      {
        ...
        model: false,
        children: [
          { icon: "mdi-plus", text: "Nuevo Pedido", url:"/admin/pedido/nuevo" },
          { icon: "mdi-plus", text: "Lista Pedidos", url:"/admin/pedido" }
        ],
      },
      { icon: "mdi-cog", text: "Settings",url:"/admin" },
    ],
  }),
};
</script>
